...
{
    public partial class FanXiuDjCha : Office2007Form
    {
        ...
        private List<BaseIList> schData()
        {
            ...
            UserProc.CheckTime = "";
            var exp = Expressionable.Create<BaseIList>().And((b)=>b.leibie == "返修登记");
        ...
        private void 刷新ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            chkZZ.cobodgv.RefList(coboDGV.leibie.色号类别);
        ...
        private void 打印ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (this.dgvEX1.Rows.Count == 0)
                return;
            this.lblwait.showme();
            this.dgvEX1.Print("返修登记", UserProc.CheckTime);
            this.lblwait.hideme();
        }
