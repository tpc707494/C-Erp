...
{
    public partial class ChanLiangDjCha : Office2007Form
    {
        ...
        {
            UserProc.CheckTime = "";
            var exp = Expressionable.Create<BaseIList>().And(it=>it.leibie == "产量登记");
            ...
            exp.And(b => b.item3 != ("开卡")).And(b => b.item3 != ("计划")).And(b => b.item3 != ("开单"));
        ...
        private void 打印ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (this.dgvEX1.Rows.Count == 0)
                return;
            this.lblwait.showme();
            this.dgvEX1.Print("一统一车间染色产量", UserProc.CheckTime);
            this.lblwait.hideme();
        }
    }
}
